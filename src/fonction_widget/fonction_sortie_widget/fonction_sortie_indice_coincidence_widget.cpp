/**
 * \file fonction_sortie_indice_coincidence_widget.cpp
 * \brief Fichier d'implémentation de la classe fonction_sortie_indice_coincidence_widget.
...
/** --------------------------------------------------------------------------------------
 * \brief Constructeur de la classe fonction_sortie_indice_coincidence_widget.
 * \param fonction Un pointeur sur la fonction associée.
 * \param parent Un pointeur sur le widget parent.
 */
fonction_sortie_indice_coincidence_widget::fonction_sortie_indice_coincidence_widget(base_fonction *fonction, QWidget *parent)
    : base_fonction_widget(fonction, parent), m_indices_textes( ((fonction_sortie_indice_coincidence*)fonction)->get_indices_textes())
{
    init();
}
 ...
 */
void fonction_sortie_indice_coincidence_widget::on_externe_fbs_textes_modifie()
{
    m_indices_textes = ((fonction_sortie_indice_coincidence*)m_fonction)->get_indices_textes();
 ...
 */
void fonction_sortie_indice_coincidence_widget::creer_liste_texte()
{
    m_liste_texte->clear();

    int i = 1;
    for ( textes::iterator it = m_indices_textes.begin(); it != m_indices_textes.end(); ++it )
    {
 ...
 */
void fonction_sortie_indice_coincidence_widget::init()
{
    ...
    connect((fonction_sortie_indice_coincidence*)m_fonction, SIGNAL(signal_fbs_textes_modifie()), this, SLOT(on_externe_fbs_textes_modifie()));
}
 ...
 */
void fonction_sortie_indice_coincidence_widget::onTexteDoubleClicked(QListWidgetItem* item)
{
