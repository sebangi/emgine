...
{
    setWindowTitle( QObject::tr("Fonction") + " " + m_parametre->get_fonction_parent()->get_nom());

    QVBoxLayout * central_layout = new QVBoxLayout();
    central_layout->setMargin(5);
    central_layout->setSpacing(0);

    QLabel * item_nom = new QLabel( QObject::tr("Paramètre") + " " + m_parametre->get_nom());
    ...
    QLabel * item_algo = new QLabel( QObject::tr("Algorithme") + " : " + m_parametre->get_aide_algorithme());
